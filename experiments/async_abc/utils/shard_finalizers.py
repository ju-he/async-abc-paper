...
_FINALIZER_REGISTRY: Dict[str, Any] = {
    ...
    "straggler_twinB_f0": finalize_straggler_experiment,
    "straggler_twinB_f1": finalize_straggler_experiment,
    "straggler_twinB_f5": finalize_straggler_experiment,
    "straggler_twinB_f10": finalize_straggler_experiment,
    "straggler_twinB_f20": finalize_straggler_experiment,
    "straggler_twin_f0": finalize_straggler_experiment,
    "straggler_twin_f1": finalize_straggler_experiment,
    "straggler_twin_f5": finalize_straggler_experiment,
    "straggler_twin_f10": finalize_straggler_experiment,
    "straggler_twin_f20": finalize_straggler_experiment,
    "straggler_async_wall": finalize_straggler_experiment,
    "straggler_async_sim": finalize_straggler_experiment,
    "straggler_twin": finalize_straggler_experiment,
    "hetero_twinprobe_s0p0": finalize_runtime_heterogeneity_experiment,
    "hetero_twinprobe_s0p5": finalize_runtime_heterogeneity_experiment,
    "hetero_twinprobe_s1p0": finalize_runtime_heterogeneity_experiment,
    "hetero_twinprobe_s1p5": finalize_runtime_heterogeneity_experiment,
    "hetero_twinprobe_s2p0": finalize_runtime_heterogeneity_experiment,
    "hetero_async_sim": finalize_runtime_heterogeneity_experiment,
    "hetero_twin": finalize_runtime_heterogeneity_experiment,
    "hetero_twin_s0p0": finalize_runtime_heterogeneity_experiment,
    "hetero_twin_s0p5": finalize_runtime_heterogeneity_experiment,
    "hetero_twin_s1p0": finalize_runtime_heterogeneity_experiment,
    "hetero_twin_s1p5": finalize_runtime_heterogeneity_experiment,
    "hetero_twin_s2p0": finalize_runtime_heterogeneity_experiment,
    "hetero_twinB_s0p0": finalize_runtime_heterogeneity_experiment,
    "hetero_twinB_s0p5": finalize_runtime_heterogeneity_experiment,
    "hetero_twinB_s1p0": finalize_runtime_heterogeneity_experiment,
    "hetero_twinB_s1p5": finalize_runtime_heterogeneity_experiment,
    "hetero_twinB_s2p0": finalize_runtime_heterogeneity_experiment,
    ...
    "sbc_gandk_topm500": finalize_sbc_experiment,
    "sbc_gandk_topm1500": finalize_sbc_experiment,
    "sbc_gaussian_fullhist": finalize_sbc_experiment,
    "sbc_bimodal_fullhist": finalize_sbc_experiment,
    "sbc_gaussian_archive": finalize_sbc_experiment,
