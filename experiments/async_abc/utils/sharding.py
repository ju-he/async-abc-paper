...
_COMPLETED_REPLICATES_REGISTRY: Dict[str, Callable[[OutputDir, Dict[str, Any]], List[int]]] = {
    ...
    "parameter_bias": _completed_replicates_runtime_heterogeneity,
    "parameter_bias_no_amis": _completed_replicates_runtime_heterogeneity,
    "parameter_bias_drain": _completed_replicates_runtime_heterogeneity,
    "parameter_bias_strong": _completed_replicates_runtime_heterogeneity,
    "parameter_bias_strong_no_amis": _completed_replicates_runtime_heterogeneity,
    "parameter_bias_strong_drain": _completed_replicates_runtime_heterogeneity,
    ...
    "straggler_twinB_f0": _completed_replicates_straggler,
    "straggler_twinB_f1": _completed_replicates_straggler,
    "straggler_twinB_f5": _completed_replicates_straggler,
    "straggler_twinB_f10": _completed_replicates_straggler,
    "straggler_twinB_f20": _completed_replicates_straggler,
    "straggler_twin_f0": _completed_replicates_straggler,
    "straggler_twin_f1": _completed_replicates_straggler,
    "straggler_twin_f5": _completed_replicates_straggler,
    "straggler_twin_f10": _completed_replicates_straggler,
    "straggler_twin_f20": _completed_replicates_straggler,
    "straggler_async_wall": _completed_replicates_straggler,
    "straggler_async_sim": _completed_replicates_straggler,
    "straggler_twin": _completed_replicates_straggler,
    "hetero_twinprobe_s0p0": _completed_replicates_runtime_heterogeneity,
    "hetero_twinprobe_s0p5": _completed_replicates_runtime_heterogeneity,
    "hetero_twinprobe_s1p0": _completed_replicates_runtime_heterogeneity,
    "hetero_twinprobe_s1p5": _completed_replicates_runtime_heterogeneity,
