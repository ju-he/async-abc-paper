...
_EXPORTS = {
    ...
    "lotka_tol_init_diagnostic": (".audit", "lotka_tol_init_diagnostic"),
    "simulation_time_bias_report": (".audit", "simulation_time_bias_report"),
    ...
    "ess_vs_n_at_fixed_S": (".ess", "ess_vs_n_at_fixed_S"),
