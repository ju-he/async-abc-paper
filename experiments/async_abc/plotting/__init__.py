...
_EXPORTS = {
    ...
    "write_plot_metadata": (".export", "write_plot_metadata"),
    ...
    "plot_archive_evolution_diagnostic": (".reporters", "plot_archive_evolution_diagnostic"),
    "plot_attempts_to_target_summary": (".reporters", "plot_attempts_to_target_summary"),
    "plot_attempts_to_target_diagnostic": (".reporters", "plot_attempts_to_target_diagnostic"),
    "plot_quality_vs_attempt_budget": (".reporters", "plot_quality_vs_attempt_budget"),
    "plot_quality_vs_attempt_budget_diagnostic": (".reporters", "plot_quality_vs_attempt_budget_diagnostic"),
    "plot_quality_vs_posterior_samples": (".reporters", "plot_quality_vs_posterior_samples"),
    "plot_quality_vs_posterior_samples_diagnostic": (".reporters", "plot_quality_vs_posterior_samples_diagnostic"),
    "plot_quality_vs_wall_time": (".reporters", "plot_quality_vs_wall_time"),
    ...
    "plot_time_to_target_diagnostic": (".reporters", "plot_time_to_target_diagnostic"),
    "plot_tolerance_trajectory": (".reporters", "plot_tolerance_trajectory"),
    "plot_tolerance_trajectory_diagnostic": (".reporters", "plot_tolerance_trajectory_diagnostic"),
    ...
    "plot_ablation_amis_isolation": (".reporters", "plot_ablation_amis_isolation"),
...
__all__ = [
    ...
    "plot_archive_evolution_diagnostic",
