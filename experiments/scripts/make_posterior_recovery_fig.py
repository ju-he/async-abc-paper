...
On the two fast simulators (g-and-k, Lotka--Volterra) the asynchronous method
reaches a markedly lower Wasserstein within the budget; on the expensive
Cellular Potts simulator the two are comparable (see also fig_cpm_recovery_diff).
