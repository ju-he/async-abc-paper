...
last_updated: "2026-04-14T17:43:17.007Z"
...
| Phase 04-reproducibility P03 | 525683 | 2 tasks | 2 files |
...
- [Phase 04-reproducibility]: Generic gate rule (any non-empty CSV in data/) avoids brittle per-experiment filename manifests — no per-experiment manifest needed (D-07)
- [Phase 04-reproducibility]: Gate layers on top of rc!=0 check via elif branch — prevents double-counting and satisfies D-08
